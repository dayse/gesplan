...
public class RelatorioListagemAnaliseMaquina extends DeclaracaoAbstrata {

	@Override
	public void gerarRelatorio(List dados, Map<String, Object> parametros) throws RelatorioException {

		String nomeArquivo = "RelatorioListagemAnaliseMaquina.pdf";

		InputStream jasper = super.recuperaJasper(Relatorio.JASPER_LISTAGEM_ANALISE_MAQUINA);
