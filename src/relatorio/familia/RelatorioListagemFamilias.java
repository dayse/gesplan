 ...
 *
 */
public class RelatorioListagemFamilias extends DeclaracaoAbstrata  {

	@Override
	public void gerarRelatorio(List dados, Map<String, Object> parametros) throws RelatorioException {
			
		System.out.println("*********** PASSO 4 *****************");
		String nomeArquivo = "RelatorioListagemFamilias.pdf";
		// recupera do stream o arquivo jasper compilado usando o caminho
		// completo como parametro	
		InputStream jasper = super.recuperaJasper(Relatorio.JASPER_LISTAGEM_DE_FAMILIAS);
