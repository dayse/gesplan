 ...
 *
 */
public class RelatorioListagemRecModels extends DeclaracaoAbstrata {
	...
	public void gerarRelatorio(List dados, Map<String, Object> parametros) throws RelatorioException {
		...
		String nomeArquivo = "RelatorioListagemRecModels.pdf";
		// recupera do stream o arquivo jasper compilado usando o caminho
		// completo como parametro	
		InputStream jasper = super.recuperaJasper(Relatorio.JASPER_LISTAGEM_DE_RECMODELS);
